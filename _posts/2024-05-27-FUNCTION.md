...
|          TRIM(문자)          | 왼쪽 혹은 오른쪽에 존재하는 공백, 특정 문자 제거 | TRIM('   aabbaaccaa   ')<br />TRIM(BOTH FROM '   aabbaaccaa   ')<br />TRIM(BOTH 'a' FROM 'aabbaaccaa')<br />TRIM(LEADING FROM '   aabbaaccaa   ')<br />TRIM(LEADING 'a' FROM 'aabbaaccaa')<br />TRIM(TRAILING FROM '   aabbaaccaa   ')<br />TRIM(TRAILING 'a' FROM 'aabbaaccaa') | 'aabbaaccaa'<br />'aabbaaccaa'<br />'bbaacc'<br />'aabbaaccaa   '<br />'bbaaccaa'<br />'   aabbaaccaa'<br />'aabbaacc' | BOTH : 양쪽 삭제<br />LEADING : 왼쪽 삭제<br />TRAILING : 오른쪽 삭제 |
...
| REPLACE(문자1, 문자2, 문자3) |     문자 1에서 문자 2를 찾아 문자 3으로 치환     |                 REPLACE('abba', 'ab', 'cd')                  |                             cdba                             |                  문자3 생략 시 문자 2 삭제                   |
