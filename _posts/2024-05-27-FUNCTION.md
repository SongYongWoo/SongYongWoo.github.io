...
| CURRENT_TIMESTAMP()                                          | 현재 날짜와 시간을 출력                                      | CURRENT_TIMESTAMP()                     | 2024-05-28 10:43:30 |
| CURRENT_DATE()                                               | 현재 날짜 출력                                               | CURRENT_DATE()                          | 2024-05-28          |
| DATE_ADD<br />(날짜, interval 숫자 <br />(second\|minute\|hour\|<br />day\|month\|year)) | 날짜에 특정 숫자만큼 초, 분, 시간, 일, 월 ,년을 더함<br />숫자가 음수일 경우 뺌 | DATE_ADD(NOW(), interval 3 year)        | 2027-05-28 10:43:30 |
| DATE_SUB<br />(날짜, interval 숫자 <br />(second\|minute\|hour\|<br />day\|month\|year)) | 날짜에 특정 숫자만큼 초, 분, 시간, 일, 월 ,년을 뺌<br />숫자가 음수일 경우 더함 | DATE_SUB(NOW(), interval 3 year)        | 2021-05-28 10:43:30 |
| DATE_FORMAT(날짜, 날짜 포멧)                                 | 날짜의 형식을 지정한 포멧으로 변경<br />포멧은 ''안에 입력 되어야 하며 대소문자를 구분.<br />%Y : 네 자리수 연도, %y : 년도 뒤 두 자리만 표시  <br />%M : 월을 영어 표시, %m : 두 자리수 월<br />%D : 일 뒤에 th 표시, %d : 두 자리수 일 | DATE_FORMAT(CURRENT_DATE(), '%Y/%m/%d') | 2024/05/28          |
| STR_TO_DATE(문자, 날짜 포멧)                                 | 문자로 표시된 날짜를 날짜 데이터로 변경<br />문자로 표시된 날짜와 날짜 포멧은 동일해야함. | STR_TO_DATE('20200528','%Y%m%d')        | 20200528            |
| DATEDIFF(날짜1, 날짜2)                                       | 두 날짜 차이의 일 수를 계산<br />날짜1- 날짜2                | DATEDIFF(CURRENT_DATE(),order_date)     | 3                   |
